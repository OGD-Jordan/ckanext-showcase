...
def showcase_base_schema(
    ...
    schema = {
        ...
        'title': [not_empty, unicode_safe, tk.get_validator('validate_english_text')],
        'title_ar': [convert_to_extras, not_empty, unicode_safe, tk.get_validator('validate_arabic_text')],
